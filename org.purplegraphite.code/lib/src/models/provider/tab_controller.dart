...
class STabController extends TabController {
  ...
  /// Creates a new [STabController] with `index`, `previousIndex`, and `length`
  /// if they are non-null.
  ///
  /// This method is used by [DefaultTabController].
  ///
  /// When [DefaultTabController._length] is updated, this method is called to
  /// create a new [STabController] without creating a new [AnimationController].
  STabController copyWith({int index, int length, int previousIndex}) {
    return STabController._(
      index: index ?? _index,
  ...
  /// drag scrolling.
  ///
  /// If this [STabController] was disposed, then return null.
