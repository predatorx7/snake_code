...
/// Signature for the [CreamyField.buildCounter] callback.
...
class _TextFieldSelectionGestureDetectorBuilder
  ...
  final _CreamyFieldState _state;
...
class CreamyField extends StatefulWidget {
  ...
  /// to [CreamyField.noMaxLength] then only the current character count is displayed.
  ///
  ...
  ///
  /// This value must be either null, [CreamyField.noMaxLength], or greater than 0.
  /// If null (the default) then there is no limit to the number of characters
  /// that can be entered. If set to [CreamyField.noMaxLength], then no limit will
